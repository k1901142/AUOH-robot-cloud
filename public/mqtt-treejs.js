...
load_geometries(). then(() =>{
    ...
    offsets[1].add(joints[2]); //kiinnitetään nivel 2
    ...
    offsets[3].add(joints[3]); //kiinnitetään nivel 3
...
); // kun palaa geometriasta, niin kutsuu sisälle kirjoitettua funktiota nuoli=call back
...
mqtt_client.on('message', (topic, message) => {
    ...
    joints[1].rotation.set(THREE.Math.degToRad(joint_data.joints[0]),0);
